  ...
  describe '#thank_you' do
    ...
    it 'creates valid email' do
      ...
      stub_request(:post, "https://api.sendgrid.com/v3/mail/send").
        with(:body => "{\"from\":{\"email\":\"justin@healthmatchup.com\"},\"personalizations\":[{\"to\":[{\"email\":\"#{ email }\",\"name\":\"#{ name }\"}],\"substitutions\":{\"\\u0026lt;%FirstName%\\u0026gt;\":\"#{ lead.first_name }\"}}],\"content\":[{\"type\":\"text/html\",\"value\":\"?\"}],\"template_id\":\"#{ template_id }\"}",
