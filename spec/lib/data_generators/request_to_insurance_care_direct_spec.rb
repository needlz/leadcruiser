  ...
  describe '#success?' do
    ...
    before do
      stub_request(:post, "http://myhealthlineone.com/API/LeadReceiver.api").
        with(:body => "LeadId=1&SourceID=481&SourceCode=RickTest&Passphrase=fcunytv51l30v1pujdkog6u3e&FirstName=John&LastName=Doe&Address=&City=&State=&Zip=10001&Email=test%40example.com&DayPhone=2-12-22&EveningPhone=&DateOfBirth=&Address2=&IPAddress=127.1.1.1&Source=source&LandingPage=http%3A%2F%2Fgethealthcare.co&ExistingConditions=&Gender=&HeightFT=&HeightIN=&Weight=&Smoker=&Income=&SpousePreExistingConditions=&SpouseGender=&SpouseHeightFT=&SpouseHeightIN=&SpouseSmoker=&SpouseWeight=&Child1PreExistingConditions=&Child1Gender=&Child1HeightFT=&Child1HeightIN=&Child1Smoker=&Child1Weight=&Child2PreExistingConditions=&Child2Gender=&Child2HeightFT=&Child2HeightIN=&Child2Smoker=&Child2Weight=&Child3PreExistingConditions=&Child3Gender=&Child3HeightFT=&Child3HeightIN=&Child3Smoker=&Child3Weight=",
