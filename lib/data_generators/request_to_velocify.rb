class RequestToVelocify < ClientRequestGenerator
  ...
  def perform_http_request(exclusive)
    HTTParty.post request_url + '?Provider=Boberdoo&Client=30277&CampaignId=35&XmlResponse=true',
                  body: velocify_params.to_json,
