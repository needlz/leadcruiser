...
class Lead < ActiveRecord::Base
  ...
  delegate :health_insurance?, :pet_insurance?, to: :vertical
  ...
  scope :without_responses_from_boberdoo, ->{ where_not_exists(:responses, client_name: ClientsVertical::BOBERDOO) }
